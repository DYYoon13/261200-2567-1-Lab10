...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] args) {
        ...
        Thread emmaThread = new Thread(() -> {
            Turtle emma = new Turtle();
            emma.penColor("pink");
            emma.width(10);
            emma.speed(500);
            emma.left(90);
        ...
        Thread peterThread = new Thread(() -> {
            Turtle peter = new Turtle();
            peter.penColor("black");
            peter.speed(500);
            peter.forward(100);
            
        });

        // Add the rest of the turtles here with similar thread logic
